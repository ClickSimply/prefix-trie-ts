...
export class Trie {
     ...
     * @memberOf Trie
     */
    private static _append(trie, letter, index, array) {
     ...
     * @memberOf Trie
     */
    private static _checkPrefix(prefixNode, prefix: string) {
     ...
     * @memberOf Trie
     */
    private static _recursePrefix(node, prefix, prefixes: string[] = []) {
        let word = prefix;
